...
const LoginPage = () => {
    ...
    function login() {
        dispatch(fetchLogin(values, (user) => {
            authenticate(user)
            ...
            <div className={style.login}>
                <div className={style.login_form}>
                    ...
                    <div className={style.form_btn}>
                        <Button onClick={handleSubmit} disabled={!values || !values.email && !values.password} color="gray">로그인</Button>
                    </div>
                    <div className={style.form_btn}>
                        <Button color="green" onClick={handleClick}>회원가입</Button>
                    </div>
                </div>
